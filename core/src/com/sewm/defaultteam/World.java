...
//    ArrayList<Target> targets_;
    ...
    {
        entities_.add(new Enemy(new Vector2(1000.f, 300.f),enemy_easy_));
        entities_.add(new Enemy(new Vector2(100.f, 300.f),enemy_easy_));
        entities_.add(new Enemy(new Vector2(1000.f, 900.f),enemy_easy_));
        entities_.add(new Enemy(new Vector2(1200.f, 300.f),enemy_medium_));
        entities_.add(new Enemy(new Vector2(800.f, 300.f),enemy_hard_));
