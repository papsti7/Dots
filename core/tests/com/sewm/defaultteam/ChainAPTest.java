...
public class ChainAPTest {
    ...
    public void testTrigger() throws Exception {
        ...
        GameScreen.worldController_.entities_.add(new NormalEnemy(0,0, new EnemyAttribute(1, 3.f, 4, 1), 3, 1, enemy_easy_textures, 1));
        GameScreen.worldController_.entities_.add(new NormalEnemy(10,12, new EnemyAttribute(1, 3.f, 4, 1), 3, 1, enemy_easy_textures, 1));
